...
SOURCE_SCHEMA = "test_bi_dwh" # both source and target has same schema name
BASE_TABLE = "base_22"
PR_TABLE = '"pr_22"'
TARGET_SCHEMA = "test_bi_dwh" # both source and target has same schema name
TARGET_TABLE = "finalwith_2022_pr_new"
LOG_TABLE = "removed_duplicate_policie_new"
log_schema= "test_logs"
...
def append_base_pr():
    ...
    df = df.sort_values(
        by=[REG_NO_COLUMN,"cleaned_chassis_engine_no",CORRECT_INSURANCE_NAME, POLICY_START_COLUMN, POLICY_END_COLUMN], 
...
with DAG(
    ...
    append_task = PythonOperator(task_id="append_base_pr_o", python_callable=append_base_pr)
